...
mixin _$CommentEntity {
  ...
  BeaconEntity get beacon => throw _privateConstructorUsedError;
...
class _$CommentEntityImpl implements _CommentEntity {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, content, author, beacon, createdAt);
...
abstract class _CommentEntity implements CommentEntity {
  const factory _CommentEntity(
      ...
      required final BeaconEntity beacon,
      required final DateTime createdAt}) = _$CommentEntityImpl;
