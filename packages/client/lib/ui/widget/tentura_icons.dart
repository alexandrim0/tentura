...
// Set kAssetPackage by fromEnvironment to able Widgetbook import assets
...
class TenturaIcons {
  ...
  static const comments = IconData(
    0xe905,
    fontFamily: _fontFamily,
    fontPackage: kAssetPackage,
  );
  ...
  static const favorites = IconData(
    0xe907,
    fontFamily: _fontFamily,
    fontPackage: kAssetPackage,
  );
  ...
  static const graphPost = IconData(
    0xe909,
    fontFamily: _fontFamily,
    fontPackage: kAssetPackage,
  );
  ...
  static const switcher = IconData(
    0xe90e,
    fontFamily: _fontFamily,
    fontPackage: kAssetPackage,
  );
  ...
  static const _fontFamily = 'Tentura';
}
